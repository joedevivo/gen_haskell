-module(gen_haskell_parse_transform).
...
walk_ast(Acc, [{attribute, L, module, Module}=H|T], TheState) ->
    ...
    %%Behaviour = {attribute, L, behaviour, gen_haskell},
...
func({start_link, 0}, L, #state{module=Module}) ->
    {function,L,start_link,0,
          [{clause,L,[],[],
               [{call,L,
                    {remote,L,{atom,L,gen_haskell},{atom,L,start_link}},
                    [{atom,L,Module}]}]}]};
func({start, 0}, L, #state{module=Module}) ->
    {function,L,start,0,
          [{clause,L,[],[],
               [{call,L,
                    {remote,L,{atom,L,gen_haskell},{atom,L,start}},
                    [{atom,L,Module}]}]}]};
func({stop, 0}, L, #state{module=Module}) ->
    {function,L,stop,0,
          [{clause,L,[],[],
               [{call,L,
                    {remote,L,{atom,L,gen_haskell},{atom,L,stop}},
                    [{atom,L,Module}]}]}]};
func({call, 3}, L, #state{module=Module}) ->
      {function,L,call,3,
          [{clause,L,
               ...
               [],
               [{call,L,
                    {remote,L,{atom,L,gen_haskell},{atom,L,call}},
                    [{atom,L,Module},
                     {var,L,'Module'},
                     {var,L,'Function'},
                     {var,L,'Args'}]}]}]};
